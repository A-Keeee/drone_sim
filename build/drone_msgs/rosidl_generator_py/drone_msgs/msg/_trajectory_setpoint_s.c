...
bool drone_msgs__msg__trajectory_setpoint__convert_from_py(PyObject * _pymsg, void * _ros_message)
{
  // check that the passed message is of the expected Python class
  {
    ...
    assert(strncmp("drone_msgs.msg._trajectory_setpoint.TrajectorySetpoint", full_classname_dest, 54) == 0);
  }
  drone_msgs__msg__TrajectorySetpoint * ros_message = _ros_message;
  {  // header
...
PyObject * drone_msgs__msg__trajectory_setpoint__convert_to_py(void * raw_ros_message)
{
  ...
  {
    PyObject * pymessage_module = PyImport_ImportModule("drone_msgs.msg._trajectory_setpoint");
